...
public class ItemMenuInstance {
    ...
    public void setButton(int index, Material icon, String name, List<String> lores, ItemMenu.MenuItemHandler handler) {
        setButton(index, icon, (short) 0, name, lores, handler);
    }

    public void setButton(int index, Material icon, short damage, String name, List<String> lores, ItemMenu.MenuItemHandler handler) {
        ItemStack item = new ItemStack(icon, 1, damage);
